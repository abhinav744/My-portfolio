    ...
    <footer id="contact" className={styles.container}>
      ...
      <ul className={styles.links}>
        <li className={styles.link}>
          ...
          <a href="mailto:abhinavchauhan744@gmail.com">abhinavchauhan744@gmail.com</a>
        </li>
        <li className={styles.link}>
          <img src={getImageUrl("contact/linkedinIcon.png")} alt="LinkedIn icon"/>
          <a href="https://www.linkedin.com/in/abhinav-chauhan-a8658225a/">linkedin.com/Abhinav Chauhan</a>
        </li>
        <li className={styles.link}>
